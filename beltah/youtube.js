...
zokou({
  ...
  if (!arg[0]) {
    repondre("bro ou pa mete mizik ou anvi load la non.");
    return;
  }
...
_*HAITIAN-MD AP TELECHAJE FICHIER A📂*_\n\n`
       }
...
zokou({
  ...
  try {
    ...
    if (videos && videos.length > 0 && videos[0]) {
      ...
      let InfoMess = {
        image: { url: videos[0].thumbnail },
        caption: `*⏣HAITIAN-MD VIDEO DOWNLOADER⏣*\n\n*Video name :* _${Element.title}_
*Time :* _${Element.timestamp}_
*Url :* _${Element.url}_
_*\nHAITIAN MD AP TELECHAJE FUCHIER A FON TI TANN📂*_\n\n`
      };
      ...
      fileStream.on('finish', () => {
        ...
        zk.sendMessage(origineMessage, { video: { url :"./video.mp4"} , caption: "*⏣GENERATED BY ANDY MRLIT⏣*", gifPlayback: false }, { quoted: ms });
      });
